~(function (doc) {
    ...
    FallingLeaves.prototype = {
        ...
        createLeaf: function () {
            ...
            image.src = "//image.amd794.com/huaban" + self.randomInteger(1, self.num) + ".png";
            leafDiv.style.top = self.pixelValue(185);
            leafDiv.style.right = self.pixelValue(self.randomInteger(180, 200));
