...
class Banner(models.Model):
    ...
    silde_title = models.CharField(max_length=100, default='活着真好')
...
class Announcement(models.Model):
    ...
    pub_time = models.DateTimeField(u'创建时间', auto_now_add=True)
    fix_time = models.DateTimeField(u'修改时间', auto_now=True)
